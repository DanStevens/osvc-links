...
A React App that generates links to various resources for Oracle Service Cloud site, given its site name, interface
name, pod domain and virtual hostname.

This project was bootstrapped with [Create React App](https://github.com/facebook/create-react-app) and hosted to
GitHub using [gh-pages](https://www.npmjs.com/package/gh-pages) node module (see also this
